...
from gemm_py.gemm_continuous import (
    check_continuous,
    gemm_continuous,
    prepare_continuous,
)
from gemm_py.gemm_naive import check_naive, gemm_naive, prepare_naive
...
from gemm_py.gemm_unrolled import (
    gemm_unrolled2,
    gemm_unrolled4,
    gemm_unrolled8,
    gemm_unrolled16,
...
kernels = {
    ...
    "continuous_memory": GEMM(
        "continuous memory", "FP64", "CPU", "python", gemm_continuous, continuous_layout
    ),
    "unrolled2_py": GEMM(
        "unrolled2 py", "FP64", "CPU", "python", gemm_unrolled2, naive_layout
    ),
    "unrolled4_py": GEMM(
        "unrolled4 py", "FP64", "CPU", "python", gemm_unrolled4, naive_layout
    ),
    "unrolled8_py": GEMM(
        "unrolled8 py", "FP64", "CPU", "python", gemm_unrolled8, naive_layout
    ),
    "unrolled16_py": GEMM(
        "unrolled16 py", "FP64", "CPU", "python", gemm_unrolled16, naive_layout
    ),
    "unrolled32_py": GEMM(
        "unrolled32 py", "FP64", "CPU", "python", gemm_unrolled32, naive_layout
    ),
    "naive_c": GEMM("naive c", "FP64", "CPU", "c", cgemm.naive_compute, cnaive_layout),
    "naive_acc_compute": GEMM(
        "naive accumulator", "FP64", "CPU", "c", cgemm.naive_acc_compute, cnaive_layout
    ),
    "naive_cu": GEMM(
        "naive cuda", "FP64", "GPU", "cuda", cgemm.cu_naive_compute, cnaive_layout
    ),
    "numpy_FP32": GEMM(
        "numpy FP32", "FP32", "CPU", "python", gemm_numpy, numpy_FP32_layout
    ),
    "block_c": GEMM(
        "blocked c", "FP64", "CPU", "c", cgemm.block_compute, cnaive_layout
    ),
    "kernel_c": GEMM(
        "kernel c v9", "FP64", "CPU", "c", cgemm.kernel_compute, caligned_layout
    ),
}
